...
import { updateQuarterlyReflection } from "@/lib/actions";
// ... existing imports ...
import { Button } from "./ui/button";
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card";
import { Badge } from "@/components/ui/badge";
// REMOVED: Dialog imports
import { Calendar, CircleDashed, ChevronRight, PenLine } from "lucide-react";
...
export function QuarterlyReflections({
  ...
  const getStatus = (reflection?: QuarterlyReflection) => {
    const hasContent =
      reflection?.content &&
      ((reflection.content as unknown as TiptapContent).content?.length ?? 0) >
        0 &&
