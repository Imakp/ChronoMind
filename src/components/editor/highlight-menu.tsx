  ...
  useEffect(() => {
    const fetchTags = async () => {
      ...
      if (result.success && result.data) {
        setAvailableTags(
          result.data.map((t: { id: string; name: string }) => ({
            id: t.id,
            name: t.name,
          }))
        );
    ...
    >
      ...
      <div className="p-3 space-y-3">
        ...
        <div className="relative">
          ...
          <input
            ...
            placeholder={
              tags.length === 0 ? "Search or create tag..." : "Add another..."
            }
      ...
      <div className="p-3 bg-secondary/20 border-t border-border/50 flex justify-end gap-2">
        ...
        <Button
          ...
          className="h-8 text-xs bg-primary text-primary-foreground shadow-sm hover:bg-primary/90"
        >
